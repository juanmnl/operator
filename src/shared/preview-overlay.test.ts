...
import { measureBetween, formatPx, placeChip } from './redlines'
...
type Inspector = { selector: (el: Element) => string; configure?: (o: unknown) => void }
type PageWindow = Window & {
  __operatorOverlay?: { configure: (c: PreviewOverlayConfig) => void; clearAnchor: () => void; redraw: () => void; redlinesOn: () => boolean }
...
beforeEach(() => {
  ...
  page.__operatorOverlayFns = { layoutGrid, measureBetween, formatPx, placeChip }
  bridge = vi.fn()
