...
export const SPEC: Record<ApiMethod, MethodSpec> = {
  ...
  artifactExpireUndelivered: { delivery: 'invoke', impl: 'native' },
  ...
  previewCdpTargets:      { delivery: 'invoke', impl: 'native' },
  ...
  previewShotCapture:     { delivery: 'invoke', impl: 'native' },
  previewShotImage:       { delivery: 'invoke', impl: 'native' },
  previewShotDelete:      { delivery: 'invoke', impl: 'native' },
