...
export const SPEC: Record<ApiMethod, MethodSpec> = {
  ...
  onSessionUpdate:        { delivery: 'event',  impl: 'mock', rust: 'transcript.rs' },
  onOrchestratorDispatch: { delivery: 'event',  impl: 'mock', rust: 'transcript.rs' },
  onOrchestratorReply:    { delivery: 'event',  impl: 'mock', rust: 'transcript.rs' },
  getSessions:            { delivery: 'invoke', impl: 'mock', rust: 'transcript.rs' },
  chatHistory:            { delivery: 'invoke', impl: 'mock', rust: 'chatstore.rs' },
  projectReplies:         { delivery: 'invoke', impl: 'mock', rust: 'chatstore.rs' },
  setActiveSession:       { delivery: 'send',   impl: 'mock', rust: 'transcript.rs' },
  getDevPorts:            { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  sessionPorts:           { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  noteSessionPort:        { delivery: 'send',   impl: 'mock', rust: 'lib.rs' },
  artifactReports:        { delivery: 'invoke', impl: 'mock', rust: 'artifacts.rs' },
  artifactPendingStatus:  { delivery: 'invoke', impl: 'mock', rust: 'artifacts.rs' },
  artifactAckStatus:      { delivery: 'invoke', impl: 'mock', rust: 'artifacts.rs' },
  ...
  onQuitRequested:        { delivery: 'event',  impl: 'mock', rust: 'quit.rs' },
  quitDialogShown:        { delivery: 'send',   impl: 'mock', rust: 'quit.rs' },
  quitDecision:           { delivery: 'send',   impl: 'mock', rust: 'quit.rs' },
  quitSetAsk:             { delivery: 'send',   impl: 'mock', rust: 'quit.rs' },
  folderPrefsLoad:        { delivery: 'invoke', impl: 'mock', rust: 'folderprefs.rs' },
  folderPrefsLoadGlobal:  { delivery: 'invoke', impl: 'mock', rust: 'folderprefs.rs' },
  folderPrefsSaveSettings:{ delivery: 'invoke', impl: 'mock', rust: 'folderprefs.rs' },
  folderPrefsSaveMd:      { delivery: 'invoke', impl: 'mock', rust: 'folderprefs.rs' },
  folderPrefsCreateFile:  { delivery: 'invoke', impl: 'mock', rust: 'folderprefs.rs' },
  getMcpServers:          { delivery: 'invoke', impl: 'mock', rust: 'mcp.rs' },
  inspectRepo:            { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  worktreeCreate:         { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  worktreeStatus:         { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  projectIdentity:        { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  pathExists:             { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  worktreeRemove:         { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  worktreeDiff:           { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  branchDiff:             { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  runCheck:               { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  worktreeCommit:         { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  worktreeMerge:          { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  worktreeDiscard:        { delivery: 'invoke', impl: 'mock', rust: 'worktree.rs' },
  agentsList:             { delivery: 'invoke', impl: 'mock', rust: 'agents.rs' },
  agentSave:              { delivery: 'invoke', impl: 'mock', rust: 'agents.rs' },
  agentDelete:            { delivery: 'invoke', impl: 'mock', rust: 'agents.rs' },
  getUsageStats:          { delivery: 'invoke', impl: 'mock', rust: 'usage.rs' },
  getUsageInsights:       { delivery: 'invoke', impl: 'mock', rust: 'usage.rs' },
  saveSessions:           { delivery: 'send',   impl: 'mock', rust: 'core.rs' },
  loadSessions:           { delivery: 'invoke', impl: 'mock', rust: 'core.rs' },
  saveProjects:           { delivery: 'send',   impl: 'mock', rust: 'core.rs' },
  loadProjects:           { delivery: 'invoke', impl: 'mock', rust: 'core.rs' },
  saveRoleDefaults:       { delivery: 'send',   impl: 'mock', rust: 'core.rs' },
  loadRoleDefaults:       { delivery: 'invoke', impl: 'mock', rust: 'core.rs' },
  backupProjects:         { delivery: 'invoke', impl: 'mock', rust: 'core.rs' },
  planLimits:             { delivery: 'invoke', impl: 'mock', rust: 'planlimits.rs' },
  projectAssetDir:        { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  moodboardAdd:           { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  moodboardList:          { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  moodboardImage:         { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  moodboardRemove:        { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  previewInspectOpen:     { delivery: 'invoke', impl: 'mock', rust: 'lib.rs' },
  previewInspectMove:     { delivery: 'send',   impl: 'mock', rust: 'lib.rs' },
  previewInspectClose:    { delivery: 'send',   impl: 'mock', rust: 'lib.rs' },
  onPreviewPick:          { delivery: 'event',  impl: 'mock', rust: 'lib.rs' },
  checkUpdate:            { delivery: 'invoke', impl: 'mock', rust: 'plugin-updater' },
  installUpdate:          { delivery: 'invoke', impl: 'mock', rust: 'plugin-updater' },
}
